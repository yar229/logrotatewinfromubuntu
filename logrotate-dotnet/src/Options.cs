...
namespace LogRotate
{
    ...
    public static class Options
    {
        ...
        public static string DefaultCompressCommand { get; } =
            Environment.GetEnvironmentVariable(EviromentVariables.Compress)
            ?? ""; //"gzip";

        public static string DefaultUncompressCommand { get; } =
            Environment.GetEnvironmentVariable(EviromentVariables.Uncompress)
            ?? "gunzip";

        public static string DefaultCompressExt { get; } = ".gz";

        public static string DefaultMailCommand { get; } =
            Environment.GetEnvironmentVariable(EviromentVariables.MailCommand)
            ?? "mail";
